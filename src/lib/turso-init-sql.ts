...
export const TURSO_STATEMENTS: string[] = [
  ...
  `CREATE TABLE IF NOT EXISTS "DonorReportObligation" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "organizationId" TEXT NOT NULL,
    "applicationId" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "type" TEXT NOT NULL DEFAULT 'تقرير مرحلي',
    ...
    "isDemo" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "DonorReportObligation_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "DonorReportObligation_applicationId_fkey" FOREIGN KEY ("applicationId") REFERENCES "GrantApplication" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "DonorReportObligation_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
  )`,

  `CREATE TABLE IF NOT EXISTS "DonorSupportRecord" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "organizationId" TEXT NOT NULL,
    ...
    "isDemo" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "DonorSupportRecord_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "DonorSupportRecord_donorId_fkey" FOREIGN KEY ("donorId") REFERENCES "Donor" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "DonorSupportRecord_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "DonorSupportRecord_applicationId_fkey" FOREIGN KEY ("applicationId") REFERENCES "GrantApplication" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "DonorSupportRecord_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
  )`,

  `CREATE TABLE IF NOT EXISTS "DonorCorrespondence" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "organizationId" TEXT NOT NULL,
    "donorId" TEXT NOT NULL,
    "applicationId" TEXT,
    ...
    "isDemo" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "DonorCorrespondence_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "DonorCorrespondence_donorId_fkey" FOREIGN KEY ("donorId") REFERENCES "Donor" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "DonorCorrespondence_applicationId_fkey" FOREIGN KEY ("applicationId") REFERENCES "GrantApplication" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "DonorCorrespondence_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
  )`,

  `CREATE UNIQUE INDEX IF NOT EXISTS "User_email_key" ON "User"("email")`,
  `CREATE INDEX IF NOT EXISTS "DonorReportObligation_organizationId_idx" ON "DonorReportObligation"("organizationId")`,
  `CREATE INDEX IF NOT EXISTS "DonorReportObligation_applicationId_idx" ON "DonorReportObligation"("applicationId")`,
  `CREATE INDEX IF NOT EXISTS "DonorReportObligation_dueDate_idx" ON "DonorReportObligation"("dueDate")`,
  `CREATE INDEX IF NOT EXISTS "DonorSupportRecord_organizationId_idx" ON "DonorSupportRecord"("organizationId")`,
  `CREATE INDEX IF NOT EXISTS "DonorSupportRecord_donorId_idx" ON "DonorSupportRecord"("donorId")`,
  `CREATE INDEX IF NOT EXISTS "DonorCorrespondence_organizationId_idx" ON "DonorCorrespondence"("organizationId")`,
  `CREATE INDEX IF NOT EXISTS "DonorCorrespondence_donorId_idx" ON "DonorCorrespondence"("donorId")`,
